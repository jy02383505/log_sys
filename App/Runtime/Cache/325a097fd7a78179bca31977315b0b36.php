	...
	<div class="container">
		<div class="page-header">
			...
			<h4><?php echo L('STRUCTURE');?> -
                ...
                <a href="<?php echo U('Kaoqin/config');?>">指纹考勤机用户设置</a> |
				<a href="http://5kcrm.com/index.php?m=doc&a=index&id=44" target="_blank" style="font-size: 12px;color: rgb(255, 102, 0);"><img width="15px;" src="__PUBLIC__/img/help.png"/> <?php echo L('HELP');?></a>
			...
			<form action="<?php echo U('user/delete');?>" id="user_form" method="post">
				<div class="span12">
					...
					<div class="pull-right">
						...
						<?php if(session('?admin')): ?>&nbsp; <a id="add_department" class="btn btn-primary"><i class="icon-plus"></i>&nbsp; <?php echo L('ADD_DEPARTMENT');?></a><?php endif; ?>
						&nbsp; <a id="add_role" class="btn btn-primary"><i class="icon-plus"></i>&nbsp; <?php echo L('ADD_POSITION');?></a>
					</div>
				</div>
				<div class="span12">
