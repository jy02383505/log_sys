			...
			<form action="<?php echo U('log/mylog_add');?>" method="post">
				...
				<table class="table" width="95%" border="0" cellspacing="1" cellpadding="0">
					<thead>
						<tr>
							<td>&nbsp;</td>
							<td><input name="submit" class="btn btn-primary" type="submit" value="<?php echo L('SAVE');?>"/>&nbsp; <input class="btn btn-primary" name="submit" type="submit" value="<?php echo L('SAVE AND NEW');?>"/> &nbsp;<input class="btn btn-primary" type="reset" value="<?php echo L('CANCEL');?>"/></td>
						</tr>
					</thead>
					<tfoot>
						<tr> 
							<td>&nbsp;</td>
							<td><input name="submit" class="btn btn-primary" type="submit" value="<?php echo L('SAVE');?>"/> &nbsp;<input name="submit" class="btn btn-primary" type="submit" value="<?php echo L('SAVE AND NEW');?>"/>&nbsp; <input class="btn btn-primary" type="reset" value="<?php echo L('CANCEL');?>"/></td>					
						</tr>
					</tfoot>
					<tbody width="100%">
						<tr>
						...
						<tr>
							...
							<td>
                            <?php if((ACTION_NAME) == "add"): ?><input type="text" id="the_date" name="the_date" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate" value="<?php echo ($datas["the_date"]); ?>" style="width:140px"/>
                            <?php else: ?>
                            <input type="text" id="the_date" name="the_date" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate" value="<?php echo ($the_date); ?>" style="width:140px"/><?php endif; ?>
                            
                            日志统计以此为准，允许设置为过去的某天
                            </td>						
						</tr>                        
						<tr>
							<td width="20%" class="tdleft"><?php echo L('LOG_CATEGORY');?></td>
							<td><input type="radio" name="category_id" value="1" checked>  <?php echo L('COMMUNICATION_LOG');?>&nbsp;  &nbsp; <input type="radio" name="category_id" value="4" checked> <?php echo L('DAILY_REPROT');?> &nbsp;  &nbsp; <input type="radio" name="category_id" value="3"> <?php echo L('WEEKLY_REPROT');?> &nbsp;  &nbsp; <input type="radio" name="category_id" value="2"> <?php echo L('MONTHLY_REPROT');?></td>
						</tr>
						<tr>
