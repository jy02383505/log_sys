	...
	<div class="row">
		<div class="span2 knowledgecate">
			<ul class="nav nav-list">
				...
				<li><a href="<?php echo U('action_log/index','module=business&by='.$_GET['by']);?>" <?php if($_GET['module'] == 'business'): ?>class="active"<?php endif; ?>><i class="icon-chevron-right"></i><?php echo L('BUSINESS');?></a></li>
				<li><a href="<?php echo U('action_log/index','module=product&by='.$_GET['by']);?>" <?php if($_GET['module'] == 'product'): ?>class="active"<?php endif; ?>><i class="icon-chevron-right"></i><?php echo L('PRODUCT');?></a></li>
				<li><a href="<?php echo U('action_log/index','module=customer&by='.$_GET['by']);?>" <?php if($_GET['module'] == 'customer'): ?>class="active"<?php endif; ?>><i class="icon-chevron-right"></i><?php echo L('CUSTOMER');?></a></li>
				<li><a href="<?php echo U('action_log/index','module=leads&by='.$_GET['by']);?>" <?php if($_GET['module'] == 'leads'): ?>class="active"<?php endif; ?>><i class="icon-chevron-right"></i><?php echo L('LEADS');?></a></li>
			</ul>
		</div>
		<div class="span10">
			<p style="font-size:14px;">
				<b><?php echo L('FILTER');?></b>
				<a <?php if($_GET['act'] == null): ?>class="active"<?php endif; ?> href="<?php echo U('ActionLog/index','by='.$_GET['by'].'&type=1');?>"><?php echo L('ALL_THE_OPERATION');?></a> &nbsp; | &nbsp; 
				<a <?php if($_GET['act'] == 'add'): ?>class="active"<?php endif; ?> href="<?php echo U('ActionLog/index','by='.$_GET['by'].'&act=add');?>"><?php echo L('ADD');?></a> &nbsp; | &nbsp; 
				<a <?php if($_GET['act'] == 'edit'): ?>class="active"<?php endif; ?> href="<?php echo U('ActionLog/index','by='.$_GET['by'].'&act=edit');?>"><?php echo L('EDIT');?></a> &nbsp; | &nbsp; 
				<a <?php if($_GET['act'] == 'delete'): ?>class="active"<?php endif; ?> href="<?php echo U('ActionLog/index','by='.$_GET['by'].'&act=delete');?>"><?php echo L('DELETE');?></a> &nbsp; | &nbsp; 
				<a <?php if($_GET['act'] == 'completedelete'): ?>class="active"<?php endif; ?> href="<?php echo U('ActionLog/index','task&by='.$_GET['by'].'&act=completedelete');?>"><?php echo L('RECYCLE_BIN');?></a> &nbsp; | &nbsp; 
			</p>
				...
				<?php else: ?>
					...
					<tbody>
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							<td><input class="log_id" type="checkbox" name="log_id[]" value="<?php echo ($vo["log_id"]); ?>"/></td>
							...
							<td><?php echo ($vo["module_name"]); ?></a></td>
