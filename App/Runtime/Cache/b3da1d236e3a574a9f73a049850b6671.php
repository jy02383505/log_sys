...
<div class="container">
	...
	<div class="row">
		<div class="span12">
			...
			<input type="hidden" name="knowledge_id" value="<?php echo ($knowledge["knowledge_id"]); ?>"/>
				<table class="table" width="95%" border="0" cellspacing="1" cellpadding="0">
					<thead>
						<tr>
							<td><a class="btn btn-primary" href="<?php echo U('knowledge/edit','id='.$knowledge['knowledge_id']);?>"><?php echo L('EDIT');?></a>&nbsp; <a class="btn btn-primary" href="<?php echo U('knowledge/delete','id='.$knowledge['knowledge_id']);?>"><?php echo L('DELETE');?></a>&nbsp; <a class="btn" href="javascript:history.go(-1)"><?php echo L('RETURN');?></a></td>
						</tr>
					</thead>
					<tbody width="100%">
						<tr><th><?php echo L('BASIC_INFO');?></th></tr>
						<tr><td>						
						<?php if(!empty($knowledge["owner"]["user_name"])): echo L('AUTHORS');?><a class="role_info" rel="<?php echo ($knowledge["owner"]["role_id"]); ?>" href="javascript:void(0)"><?php echo ($knowledge["owner"]["user_name"]); ?></a><?php endif; ?>
						&nbsp;&nbsp;&nbsp;&nbsp;<notempty name="knowledge.update_time"><?php echo L('TIMES'); echo (date("Y-m-d",$knowledge["update_time"])); ?><notempty>
						</td>
						</tr>
						<tr><td><?php echo ($knowledge["content"]); ?></td></tr>
					</tbody>
				</table>
		</div>
	</div>
