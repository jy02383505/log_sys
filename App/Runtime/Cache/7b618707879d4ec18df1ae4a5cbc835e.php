...
<div class="container">
	<div class="page-header">
		<h4><?php if(ACTION_NAME == 'add'): ?>添加<?php else: ?>修改<?php endif; ?>年假记录</h4>
	</div>

	<form method="post" action=<?php if(ACTION_NAME == 'add'): ?>"<?php echo U('YearVacation/add');?>"<?php else: ?>"<?php echo U('YearVacation/edit');?>"<?php endif; ?>>
		<table class="table table-hover table-striped "> 
            ...
            <tr>
                <td>年假剩余天数：</td>
                <td>
    				<input type="text" name="year_vacation" value="<?php echo ($row[year_vacation]); ?>">
    			</td>
            </tr>
            ...
            <tr>
                <td> 
                    ...
                    <a href="<?php echo U('YearVacation/index');?>"><button type="button" class="btn btn-danger btn-sm">取消</button></a> 
                </td>
            </tr>  
		</table>
	</form>
