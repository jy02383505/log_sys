 ...
 $model = new Model(); foreach($users_list as $k=>$v){ ?>
                    ...
                    <td colspan="10" style="padding:0px;">
                        ...
                        <td >
                            ...
                            <?php
 for ($i=1;$i<13;$i++){ $map = array(); if ($i<10){ $tmp = "0".$i; }else{ $tmp = $i; } $this_year_month = $the_year."-".$tmp; $map = array(); $map['user_id'] = $v['user_id']; $map['the_month'] = $this_year_month; $map['checked'] = 1; $month_jiaban_hours_1 = $model->table("jl_kaoqin_jiaban")->where($map)->sum('hour_num'); $month_jiaban_hours_1 = round($month_jiaban_hours_1,1); $map = array(); $map['user_id'] = $v['user_id']; $map['sign_month'] = $this_year_month; $month_jiaban_hours_2 = $model->table("jl_kaoqin")->where($map)->sum('jiaban_hours'); $month_jiaban_hours_2 = round($month_jiaban_hours_2,1); ?>
                            
                                
                                    <ul class="tb_month">
                                    <dt><?php echo $i;?>月</dt>
                                    <dt><?php echo $month_jiaban_hours_1;?></dt>
                                    <dt class="noborder"><?php echo $month_jiaban_hours_2;?></dt>
                                    </ul>
                        ...
                        <td width="200">
                            <?php
 $map = array(); $map['user_id'] = $v['user_id']; $map['the_year'] = $the_year; $map['checked'] = 1; $year_jiaban_hours_1 = $model->table("jl_kaoqin_jiaban")->where($map)->sum('hour_num'); $year_jiaban_hours_1 = round($year_jiaban_hours_1,1); $map = array(); $map['user_id'] = $v['user_id']; $map['sign_year'] = $the_year; $year_jiaban_hours_2 = $model->table("jl_kaoqin")->where($map)->sum('jiaban_hours'); $year_jiaban_hours_2 = round($year_jiaban_hours_2,1); ?>
                            <ul class="tb_year">
                            <li><b>全年合计</b></li>
                            <li><?php echo ($year_jiaban_hours_1); ?><!--本年度--></li>
                            <li class="noborder"><?php echo ($year_jiaban_hours_2); ?></li>
