 ...
 $model = new Model(); foreach($users_list as $k=>$v){ ?>
                    ...
                    <td colspan="10" style="padding:0px;">
                        ...
                        <td width="160">
                            ...
                            <li>迟到次数</li>
                            <li>早退次数</li>
                            <li class="noborder">签到次数</li>
                            <li class="noborder">签退次数</li>
                            </ul>
                        </td>
                        ...
                        <td >
                            ...
                            <?php
 for ($i=1;$i<13;$i++){ $map = array(); if ($i<10){ $tmp = "0".$i; }else{ $tmp = $i; } $this_year_month = $the_year."-".$tmp; $map = array(); $map['user_id'] = $v['user_id']; $map['sign_month'] = $this_year_month; $map['type'] = 0; $map['cdzt_minutes'] = array('gt','0'); $chidao_num = $model->table("jl_kaoqin")->where($map)->count(); $map = array(); $map['user_id'] = $v['user_id']; $map['sign_month'] = $this_year_month; $map['type'] = 1; $map['cdzt_minutes'] = array('gt','0'); $zhaotui_num = $model->table("jl_kaoqin")->where($map)->count(); $map = array(); $map['user_id'] = $v['user_id']; $map['sign_month'] = $this_year_month; $map['type'] = 0; $qiandao_num = $model->table("jl_kaoqin")->where($map)->count(); $map = array(); $map['user_id'] = $v['user_id']; $map['sign_month'] = $this_year_month; $map['type'] = 1; $qiantui_num = $model->table("jl_kaoqin")->where($map)->count(); ?>
                                    ...
                                    <dt class="noborder"><?php echo $qiandao_num;?></dt>
                                    <dt class="noborder"><?php echo $qiantui_num;?></dt>
                                    </ul>
                                
                            <?php
 $map = array(); $map['user_id'] = $v['user_id']; $map['sign_year'] = $the_year; $map['type'] = 0; $map['cdzt_minutes'] = array('gt','0'); $year_chidao_num = $model->table("jl_kaoqin")->where($map)->count(); $map = array(); $map['user_id'] = $v['user_id']; $map['sign_year'] = $the_year; $map['type'] = 1; $map['cdzt_minutes'] = array('gt','0'); $year_zhaotui_num = $model->table("jl_kaoqin")->where($map)->count(); $map = array(); $map['user_id'] = $v['user_id']; $map['the_year'] = $the_year; $map['type'] = 3; $map['checked'] = 1; $year_chucai_hours_3 = $model->table("jl_kaoqin_chucai")->where($map)->sum('hour_num'); $year_chucai_hours_3 = round($year_chucai_hours_3,1); } ?>
                            </div>
                        </td>
                        <td width="200">
                            <ul class="tb_year">
