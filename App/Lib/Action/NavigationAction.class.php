	...
	public function settingMenu(){
		...
		foreach($menu as $k=>$v){
			switch ($v) {
				...
				case 'contract' : 
					$menu[$k] = array('module'=>$v,'module_name'=>L('CONTACT'),'url'=>'index.php?m=contract&a=add'); break;
				case 'contract' : 
					$menu[$k] = array('module'=>$v,'module_name'=>L('TASK'),'url'=>'index.php?m=contract&a=add'); break;
				case 'receivables' : 
