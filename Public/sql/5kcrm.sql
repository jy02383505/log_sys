...
('navigation', 'a:3:{s:3:"top";a:8:{i:0;s:2:"27";i:1;s:1:"5";i:2;s:1:"2";i:3;s:1:"4";i:4;s:2:"22";i:5;s:2:"25";i:6;s:1:"8";i:7;s:2:"24";}s:4:"user";a:6:{i:0;s:2:"11";i:1;s:2:"12";i:2;s:1:"3";i:3;s:2:"14";i:4;s:2:"28";i:5;s:2:"15";}s:4:"more";a:5:{i:0;s:2:"10";i:1;s:2:"13";i:2;s:2:"21";i:3;s:2:"29";i:4;s:2:"23";}}', '公共默认菜单'),
('defaultinfo', 'a:6:{s:4:"name";s:9:"悟空CRM";s:11:"description";s:39:"开源免费的客户关系管理系统";s:5:"state";s:9:"河南省";s:4:"city";s:9:"郑州市";s:15:"allow_file_type";s:40:"pdf,doc,jpg,png,gif,txt,doc,xls,zip,docx";s:4:"logo";N;}', ''),
...
(28, '操作日志', 'http://demo.5kcrm.com/index.php?m=action_log', 'user', 4, ''),
(2, '商机', 'http://demo.5kcrm.com/index.php?m=business', 'top', 2, 'Business'),
(3, '组织架构', 'http://demo.5kcrm.com/index.php?m=user', 'user', 2, ''),
(4, '产品', 'http://demo.5kcrm.com/index.php?m=product', 'top', 3, 'Product'),
(5, '客户', 'http://demo.5kcrm.com/index.php?m=customer', 'top', 1, 'Customer'),
(27, '线索', 'http://demo.5kcrm.com/index.php?m=leads', 'top', 0, 'Leads'),
(24, '日程', 'http://demo.5kcrm.com/index.php?m=event', 'top', 7, 'Event'),
(8, '任务', 'http://demo.5kcrm.com/index.php?m=task', 'top', 6, 'Task'),
(25, '财务', 'http://demo.5kcrm.com/index.php?m=finance', 'top', 5, 'Finance'),
(10, '知识', 'http://demo.5kcrm.com/index.php?m=knowledge', 'more', 0, 'Knowledge'),
(11, '我的面板', 'http://demo.5kcrm.com/', 'user', 0, ''),
(12, '个人资料', 'http://demo.5kcrm.com/index.php?m=user&a=edit', 'user', 1, ''),
(13, '日志', 'http://demo.5kcrm.com/index.php?m=log', 'more', 1, ''),
(14, '权限分配', 'http://demo.5kcrm.com/index.php?m=user&a=role', 'user', 3, 'Role'),
(15, '系统设置', 'http://demo.5kcrm.com/index.php?m=setting', 'user', 5, 'Setting'),
(16, '公告管理', 'http://demo.5kcrm.com/index.php?m=announcement', 'user', 5, 'announcement'),
(22, '合同', 'http://demo.5kcrm.com/index.php?m=contract', 'top', 4, 'Contract'),
(21, '站内信', 'http://demo.5kcrm.com/index.php?m=message', 'more', 2, ''),
(29, '营销', 'http://demo.5kcrm.com/index.php?m=setting&a=sendsms', 'more', 3, '');
...
CREATE TABLE IF NOT EXISTS `5kcrm_product` (
  ...
  `cost_price` int(10) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `5kcrm_task` (
  ...
  `owner_role_id` int(10) NOT NULL COMMENT '任务所有者岗位',
